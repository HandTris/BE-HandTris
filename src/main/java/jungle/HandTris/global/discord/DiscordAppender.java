...
import jungle.HandTris.global.discord.model.EmbedObject;
import jungle.HandTris.global.dto.discord.DiscordConstants;
import jungle.HandTris.global.exception.DiscordLogException;
import jungle.HandTris.global.util.MDCUtil;
import jungle.HandTris.global.util.StringUtil;
...
public class DiscordAppender extends UnsynchronizedAppenderBase<ILoggingEvent> {
    ...
    protected void append(ILoggingEvent eventObject) {
        System.out.println("DiscordAppender is invoked with message: {}" + eventObject.getFormattedMessage());
